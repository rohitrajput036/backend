...
class Mongo_db{
	...
	private function prepare(){
		...
		if (isset($this->config[$this->activate]) == TRUE) {
			...
			if (empty($this->config[$this->activate]['read_preference']) || !isset($this->config[$this->activate]['read_preference'])) {
			...
			if (empty($this->config[$this->activate]['read_concern']) || !isset($this->config[$this->activate]['read_concern'])) {
