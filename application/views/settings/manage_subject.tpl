            ...
            <div class="col-lg-12 col-md-12 col-xs-12">
                <div class="box">
                    <div class="box-body">
                        <div class="col-md-12">
                            <div class="col-md-3">
                                <div class="form-group" id="subject_box">
                                    <label>Subject Name <span class="text-red">*</span></label>
                                    <input type="text" name="subject_name" id="subject_name" class="form-control" placeholder="Enter the subjects name."/>
                                    <input type="hidden" name="subject_id" id="subject_id" value="0"/>
                                    <label id="subject_error_msg"></label>
                                </div>
                            </div>
                            <div class="col-md-1">
...
<script>
    $(document).ready(function(){
        ...
        $(window).load(function(){
            ...
            var url = "{$smarty.const.API_URL}subject/get";
            $.ajax({
                method: "POST",
                url: url,
                async: true,
        ...
        $(document).on('click','#save',function(){
            ...
            request = JSON.stringify(request);
            var url = "{$smarty.const.API_URL}subject/add";
            $.ajax({
                method: "POST",
                url: url,
                async: true,
        ...
        $(document).on('click','.active_deactive',function(){
            ...
            request = JSON.stringify(request);
            var url = "{$smarty.const.API_URL}subject/delete";
            $.ajax({
                method: "POST",
                url: url,
                async: true,
