                        ...
                        <div class="col-md-12">
                            <div class="col-md-3">
                                <div class="form-group" id="relation_box">
                                    ...
                                    <input type="text" name="relation" id="relation" class="form-control" placeholder="Your relation with children."/>
                                    <input type="hidden" name="relation_id" id="relation_id" value="0"/>
                                    <label id="relation_error_msg"></label>
                                </div>
                            </div>
                            <div class="col-md-1">
                                <button id="submit" class="btn btn-primary" style="margin-top:20px">Save</button>
                            </div>
                        </div>
