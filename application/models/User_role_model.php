...
class User_role_model extends CI_Model {
    public $user_role_id, $user_id, $role_id, $is_active, $created_by, $created_on, $updated_by, $updated_on, $table_name;
    function __construct() {
        ...
        $this->table_name   = DB_NAME.'user_role'; 
    }
    ...
    function add(){
        ...
        if ($this->global_model->insert($this->table_name, $insert_data)) {
            $this->user_role_id = $this->db->insert_id();
        } else {
