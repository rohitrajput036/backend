    ...
    function add_post(){
        ...
        try {
            ...
            if (!empty($request)) {
                ...
                $this->registration_model->registration_date    = $request->data->registration_date;
                ...
                if(!$this->registration_model->check()){
                    ...
                    if($this->registration_model->registration_id > 0){
                        ...
                        $this->student_model->date_of_birth = (!empty($student_info->date_of_birth)) ? $student_info->date_of_birth : NULL;
                        ...
                        if(!$this->student_model->check()){
                            ...
                            if($this->student_model->student_id > 0){
                                ...
                                foreach($request->data->parents as $parents){
                                    ...
                                    $this->student_parents_detail_model->date_of_birth = (!empty($parents->date_of_birth)) ? $parents->date_of_birth : NULL;
