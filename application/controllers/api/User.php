    ...
    function add_post(){
        ...
        try {
            ...
            if (!empty($request)) {
                ...
                keyExist(['user_id','unique_no','first_name','middel_name','last_name','display_name','dob','gender','mobile_no','alt_mobile_no','email_id','password','alt_email_id','address_line_1','address_line_2','state_id','city_id','pincode','doj','comment','role','department'],$request->data);
                checkBlank(['request_id' => $request->control->request_id,'source' => $request->control->source,'request_time' => $request->control->request_time]);
                checkBlank(['first_name' => $request->data->first_name,'display_name' => $request->data->display_name,'dob' => $request->data->dob,'gender' => $request->data->gender,'mobile_no' => $request->data->mobile_no,'email_id' => $request->data->email_id,'password' => $request->data->password,'address_line_1'=> $request->data->address_line_1,'state_id' => $request->data->state_id,'city_id' => $request->data->city_id,'pincode' => $request->data->pincode,'doj' => $request->doj]);
