    ...
    function add_post(){
        ...
        try{
            ...
            if (!empty($request)) {
                ...
                keyExist(['area_master_id', 'city_id', 'area_name'], $request->data);
                checkBlank(['request_id' => $request->control->request_id,'source' => $request->control->source,'request_time' => $request->control->request_time]);
                checkBlank(['city_id' => $request->data->city_id, 'area_name' => $request->data->area_name]);
        ...
        try {
            ...
            if (!empty($request)) {
                ...
                if($request->data->is_active == 1){
                    $message = 'Area activate successfully';
                }else if($request->data->is_active == 2){
                    $message = 'Area dactivate successfully';
